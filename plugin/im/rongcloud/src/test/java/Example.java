...
/**
 * .
 * <a href="mailto:yangmujiang@sohu.com">Reamy(杨木江)</a> 创建于 2016/5/1 23:51
 */
public class Example {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String key = "e0x9wycfxos4q";//替换成您的appkey
        String secret = "m5tNkcXhxE6";//替换成匹配上面key的secret

        SdkHttpResult result = null;
/*
        //获取token
        result = ApiHttpClient.getToken(key, secret, "dev_1", "Reamy",
                "http://wx.qlogo.cn/mmopen/FnrmNc5Ze0K57TnUEef02R4H8MMkDicrjdhIib1VdxC4C2HtAOdU6RKGf35v6yl6APaVic4GyBScibrtvhgB7W4FnIaqRvyBAo13/0", FormatType.json);
